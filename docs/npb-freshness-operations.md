...
[Freshness手動Run #1](https://github.com/tomoya41/baseball-notes/actions/runs/36077514185)は2026-09-25 09:26 JSTに成功。Pages実HTTP 200、期待/公開`effectiveDate=2026-09-24`、Turso対象Day=`complete`、終了2/完了2/部分0/失敗0、打者53・投手13、`backup_status=exported`を診断した。対象Dayはmanual runであり、最新scheduled Day Runはまだnull。次回の全試合化後scheduled Daily Runでは、trigger=`schedule`、JST前日target、全final GameとFactのreadback、暗号化Artifact、Pages deploy後の公開日付を確認し、無人End-to-End成立を記録する。
