...
[書込みなしdry-run](https://github.com/tomoya41/baseball-notes/actions/runs/36274975254)では対象Gameが23/23打者・7/7投手、issues 0、complete。9/26全体は5/5 complete、134/134打者・41/41投手だった。[手動repair](https://github.com/tomoya41/baseball-notes/actions/runs/36275205608)では対象Gameへ打者23・投手7を追加し、9/26を5/5 completeへ修復。Turso Repository readbackは9/26に5 Game・134打者・41投手、累積40 Game・518打者Fact・161投手Fact・384 source mappings。直後のRaw再投入は新規打者0・投手0・mapping 0で、Repository JSONは一致した。Portable Export schema v4→空DBへのScratch Restore→Repository検証はPASS。暗号化Backup Artifact `npb-facts-encrypted-2026-09-26-36275205608`のみ7日保持。

対象GameのRead-only APIではソフトバンク4–0楽天、ソフトバンクPA34=楽天投手BF34、楽天PA33=ソフトバンク投手BF33、両軍投球アウト27/24、安打9/2、本塁打3/0。ホークス投手ロベルト・オスナは確認済みcanonical ID `a4d2116b-07d3-4a7a-8f8e-32f6d28759e4`、3アウト・BF3で読めた。9/25の前回修復Gameもcomplete・27打者・5投手を保持。[手動Pages publish](https://github.com/tomoya41/baseball-notes/actions/runs/36275734652)後、公開順位JSONはHTTP 200・12球団・`effectiveDate=2026-09-26`。これらはScheduled Runの成功証拠ではない。
